...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="{{ url('/') }}" class="text-white text-1xl font-semibold uppercase hover:text-gray-300">Cek Sertifikat</a>
            <a href="{{ url('/add-certificate') }}" class="w-full bg-white cta-btn font-semibold py-2 mt-5 rounded-br-lg rounded-bl-lg rounded-tr-lg shadow-lg hover:shadow-xl hover:bg-gray-300 flex items-center justify-center">
                <i class="fas fa-plus mr-3"></i> New Certificate
            </a>
        </div>
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="{{ url('certificate-list') }}" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                ...
                @else
                    <div x-show="isOpen" class="absolute w-32 bg-white rounded-lg shadow-lg py-2 mt-16">
                        <a href="{{ url('login') }}" class="block px-4 py-2 account-link hover:text-white">Sign In</a>
                    </div>
                @endauth
            </div>
        </header>
